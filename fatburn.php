...
button {
  ...
  <?php
	if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		if(strcasecmp ($plan, "Muscle Building") == 0 )
			...
			$str="Location: http://localhost/generalfitness.php?uname=".$uname;
  ...
  ?>
    ...
    <table>
      <caption>Fat Burning Workout<br><i>(5-Day Split)</i></caption>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Jogging</td>
          <td>Cycling</td>
		  <td>Alternate Dumbells Curl</td>
		  <td>Side Lateral Bent</td>
		  <td>Cross Grip Pulldown</td>
        </tr>
        <tr>
