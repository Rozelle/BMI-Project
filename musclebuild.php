...
button {
  ...
  <nav>
    ...
    <table>
      <caption>Muscle Building Workout<br><i>(5-Day Split)</i></caption>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Jogging</td>
          <td>Close Grip Pulldown</td>
		  <td>Single Arm Rowing</td>
		  <td>Dumbell Bent Over</td>
		  <td>Deadlift</td>
        </tr>
        <tr>
